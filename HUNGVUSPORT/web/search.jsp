...
<html class="no-js" lang="zxx">
    ...
    <body>
                                            ...
                                            <ul>
                                                ...
                                                <li class="active"><a href="index.html" class="clik">Football</a> <div class="mega_menu jewelry">
                                                        <div class="mega_items jewelry" class="clik">
                                                            <ul>
                                                                <li><a href="index.html" class="clik">Football shose</a></li>
                    ...
                    <div class=" pos_home_section shop_section shop_fullwidth">    
                            ...
                            <div class="col-12">
                                ...
                                <div class="shop_toolbar mb-35">
                                    ...
                                    <div class="select_option">
                                        <form action="menu">
                                            <label>Sort By</label>
                                            <select name="getproductbyselect" id="short" onchange="handleChange(this)">
                        ...
                        <div class="pagination_style shop_page">                        
                            <div class="page_number">
                                ...
                                <c:if test="${tag > 1}">
                                    <a href="#" style="padding-left: 10px; font-size: 20px"onclick="submitForm(${tag - 1}, '${txtSearch}')">Previous</a>
                                </c:if>
                                <c:forEach begin="1" end="${end}" var="i">
                                    <a id="pageIndexLink" class="${tag==i?"pageIndex":""}" href="#" style="margin-left:5px;font-size: 20px" onclick="submitForm(${i}, '${txtSearch}')">${i}</a>
                                </c:forEach>
                                <c:if test="${tag < end}">
                                    <a href="#" style="padding-left: 10px; font-size: 20px"onclick="submitForm(${tag + 1}, '${txtSearch}')">Next</a>
                                </c:if>
                            </div>
        ...
        <script>
                                        function submitForm(index, search) {
                                            ...
                                            // Create hidden input fields for data
