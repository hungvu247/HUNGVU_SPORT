                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between p-md-1">
                                            ...
                                            <div class="align-self-center">
                                                <h2 class="h1 mb-0">${requestScope.numberOfOrder}</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between p-md-1">
                                        ...
                                        <div class="align-self-center">
                                            <h2 class="h1 mb-0">${requestScope.numberOfProduct}</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between p-md-1">
                                        ...
                                        <div class="align-self-center">
                                            <h2 class="h1 mb-0">${requestScope.totalReview}</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between p-md-1">
                                        <div class="d-flex flex-row">
                                            <div class="align-self-center">
                                                <h2 class="h1 mb-0 me-4">$${requestScope.totalAmount}</h2>
                                            </div>
                                            <div>
                                                <h4>Total Sales</h4>
                                                <p class="mb-0"></p>
