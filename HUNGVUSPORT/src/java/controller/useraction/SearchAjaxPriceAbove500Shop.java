 ...
 * @author HUNG VU
 */
@WebServlet(name="SearchAjaxPriceAbove500Shop", urlPatterns={"/searchAjaxPriceAbove500Shop"})
public class SearchAjaxPriceAbove500Shop extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SearchAjaxPriceAbove500Shop</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SearchAjaxPriceAbove500Shop at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        DAO d = new DAO();
        List<Product> list = d.searchAjaxPriceAbove500Shop(500);
