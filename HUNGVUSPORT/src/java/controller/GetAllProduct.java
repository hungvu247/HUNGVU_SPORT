 ...
 * @author HUNG VU
 */
@WebServlet(name = "GetAllProduct", urlPatterns = {"/getproductbyselect"})
public class GetAllProduct extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
     String selectValue = request.getParameter("selected");
        ...
        switch (selectValue) {
            ...
            case "Lowest" ->
                list = d.getListProductAscByPrice();
            case "Highest" ->
                list = d.getListProductDescByPrice();
            case "A-Z" ->
                list = d.getListProductByFisrtChacracterAsc();
            case "Z-A" ->
                list = d.getListProductByFisrtChacracterDesc();
