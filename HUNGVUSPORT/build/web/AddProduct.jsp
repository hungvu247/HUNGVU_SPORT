    ...
    <body>
        ...
        <div class="pos_page">
            <div class="container">
                ...
                <div> <form action="addProduct" method="post">
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" id="price_product" name="price_product"><br>
                        </div>
                        <div>
                            <label for="quantity_product">Enter quantity:</label>
                            <input type="text" id="quantity_product" name="quantity_product"><br>
                        </div>
                        <div>
