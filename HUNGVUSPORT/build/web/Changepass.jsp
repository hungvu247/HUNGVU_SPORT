...
<html class="no-js" lang="zxx">
    ...
    <body>
        ...
        <div class="pos_page">
            <div class="container">
                ...
                <div> 
                    <div class="form-sub-w3">
                        <form action="changepassword?user_id=${sessionScope.user.getId()}" method="post">
                            Enter old password: <input type="password" name="oldpass" id="oldPassword" placeholder="old password" required="" /><button type="button" onclick="switchVisibility('oldPassword')">Show/hide</button><br>
                            Enter new password: <input type="password" name="newpass" id="newPassword" placeholder=" new password" required="" /><button type="button" onclick="switchVisibility('newPassword')">Show/hide</button><br>
                            Enter confirm password: <input type="password" name="passConfirm" id="confirmPassword" placeholder="Confirm password" required="" /><button type="button" onclick="switchVisibility('confirmPassword')">Show/hide</button><br>
                            <button type="submit" style="margin-top: 10px">Save</button>
                        </form>
                        <p style="color:red">${requestScope.msg}</p>

                        <p style="color:greenyellow">${requestScope.success}</p>
                    </div>                                         
                    <!--pos page inner end-->
            ...
            <!-- all js here -->
            <script>
                function switchVisibility(passwordId) {
