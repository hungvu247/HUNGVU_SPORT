    ...
    <section class="mb-4" id="doanhThuThu">
        <div class="card">
            <div class="card-header py-3">
                <h5 class="mb-0 text-center"><strong>Các sản phẩm đã bán </strong></h5>
            </div>
                    ...
                    <tbody>
                        <c:forEach items="${requestScope.listProduct}" var="p">
                            <tr>
                                ...
                                <td><img src="${p.getImg()}" style="max-width: 70px; max-height: 70px;" class="img-fluid" alt="Product Image"></td>
                                <td>${p.getQuantity()}</td>
                            </tr>
                        </c:forEach>
                    </tbody>
