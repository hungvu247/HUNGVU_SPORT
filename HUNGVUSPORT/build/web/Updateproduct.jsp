            ...
            <div class="container">
                ...
                <div>
                    <form action="updateproduct" method="post">
                        ...
                        <div>
                            <label for="name_product">Id</label>
                            <input type="text" id="name_product" name="product_id" value="${p.getProduct_id()}"readonly=""><br>
                        </div>
                        <div>
                            <label for="name_product">Enter name product:</label>
                            <input type="text" id="name_product" name="name_product" value="${p.getProduct_name()}"><br>
                        </div>
                        <div>
                            <label for="description">Enter description:</label>
                            <input type="text" id="description" name="description" value="${p.getDescription()}"><br>
                        </div>
                        <div>
                            <label for="category_id">Select type category:</label><br>
                            <select id="category_id" name="category_id">
                                <option value="${p.getCategory().getId()}"selected="">${p.getCategory().getName()}</option> 
                        ...
                        <br>
                        <div>
                            <label for="price_product">Enter price:</label><br>
                            <input type="text" id="price_product" name="price_product" value="${p.getPrice()}"><br>
                        </div>
                        <div>
                            <label for="quantity_product">Enter quantity:</label>
                            <input type="text" id="quantity_product" name="quantity_product" value="${p.getQuantity()}"><br>
                        </div>
                        <div>
                            <label for="img">Enter src img:</label>
                            <input type="text" id="img" name="img" value="${p.getImg()}"><br>
                        </div>
                        <div><p style="color:greenyellow;font-size: 20px;">${message}</p> 
                        </div>
